...
class Ind:
    """The Individual class (Ind) represents an individual in the population of the evolutionary algorithm.
    It encapsulates the genes, network structure, and fitness of an individual. The class includes methods
    for initializing an individual with given genes, expressing the genes into a weight matrix and activation
    vector, and calculating the number of active connections. This class is used to manage and manipulate the
    individuals during the evolutionary process, including their genetic representation and fitness evaluation.
    """
