...
class DataGatherer:
    ...
    """
        self.filename = filename  # File name path + prefix of output
        self.p = hyp  # Dictionary of hyperparameters

        # Initialize empty fields
        self.elite = []  # Track of the elite individuals of a population over time
        self.best = []  # Track of the best individuals found so far
        self.bestFitVec = []  # List to store best fitnesses
        ...
        self.newBest = False  # Flag to indicate whether a new best individual was found

    def gatherData(self, pop, species):
        """Collects and processes data from a population of individuals,
        including their fitness, node counts, and connection counts.
        It updates various statistics and records the best individuals
        """
        # Readability
        ...
        # --- Multi-Objective Optimization (MOO) Fronts --------------------------
    ...
    def save(self, gen=(-1), saveFullPop=False):
        ...
        # --- Generation fit/complexity stats ------------------------------------
        gStatLabel = ['x_scale', 'fit_med', 'fit_max', 'fit_top', 'fit_peak',
                      'node_med', 'conn_med']
