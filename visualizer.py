...
def visualize(args):
    ...
    fig.show()
    fig.savefig(f'{args.input.split(".")[0]}.png', bbox_inches='tight')
    ...
    if args.task == 'SparseMountainCar' or 'SparseMountainCarConti':
        ...
        color_mesh_fig.show()
        color_mesh_fig.savefig(f'{args.input.split(".")[0]}_Policy.png', bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', type=str,
                        help='Input model architecture', default='champions/smc_conti_best.out')
